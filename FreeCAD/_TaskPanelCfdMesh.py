...
class _TaskPanelCfdMesh:
    ...
    def __init__(self, obj):
        ...
        self.form.cb_dimension.addItems(_CfdMesh._CfdMesh.known_element_dimensions) ##element dimension
        self.form.cb_utility.addItems(_CfdMesh._CfdMesh.known_mesh_utility) ##mesh utility, cfmesh, snappymesh, gmesh, etc

        self.form.if_max.setToolTip("Select 0 to use default value") ##base element size
        self.form.pb_searchPointInMesh.setToolTip("Specify below a point vector inside of the mesh or press 'Search' "
                                                  "to try and automatically find a point") ## point in mesh, default 0 0 0
        self.form.if_cellsbetweenlevels.setToolTip("Number of cells between each of level of refinement.") ##no of cells between levels
        self.form.if_edgerefine.setToolTip("Number of refinement levels for all edges.") ##levels of edge refinement 
